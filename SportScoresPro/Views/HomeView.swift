...
struct HomeView: View {
    ...
    var body: some View {
        let homeDataArray: [HomeModel] = [
            HomeModel(id: 1, image: "1", titleText: "About", descriptionText: "Thank you for visiting Sport Scores Pro! This app is your hub for sport scores, betting odds, and current news."),
...
struct HomeModelView: View {
    ...
    var body: some View {
        VStack() {
            ...
            Text("\(self.homeData.descriptionText)")
                .font(.body)
                .multilineTextAlignment(.leading)
            
            Spacer()
            
            Image("\(self.homeData.image)")
                .resizable()
